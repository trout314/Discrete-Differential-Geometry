...
_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))   # repo root (data/ paths)
import discrete_differential_geometry as ddg
from discrete_differential_geometry.fk_skeleton import edges_from_facets, vertex_class_census
...
def run_point(path, lam, sweeps, vdq_scale=1.0, zleg_scale=0.0, cimp_scale=0.0,
    ...
    v = s.manifold
    if save_path:
        from discrete_differential_geometry.seed_utils import (build_metadata_comments, make_leg, obj_of,
                                 read_history)
