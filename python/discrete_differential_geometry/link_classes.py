...
Promoted from tools/link_classes.py (2026-08 cleanup, Phase 1a); that file is
now a shim whose CLI dispatches to `main` here.
...
# --------------------------------------------------------------------------
# CLI (invoked via the tools/link_classes.py shim)
# --------------------------------------------------------------------------
