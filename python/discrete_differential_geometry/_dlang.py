...
_lib.ddg_sampler_worm_chord_strict.argtypes = [
    ctypes.c_void_p, ctypes.POINTER(ctypes.c_double)]
_lib.ddg_sampler_worm_chord_strict.restype = ctypes.c_int
_lib.ddg_sampler_worm_chord_strict.errcheck = _check_int
_lib.ddg_sampler_worm_chord_config.argtypes = [
    ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint64),
    ctypes.POINTER(ctypes.c_double), ctypes.c_long, ctypes.c_double]
_lib.ddg_sampler_worm_chord_config.restype = ctypes.c_int
_lib.ddg_sampler_worm_chord_config.errcheck = _check_int
...
_lib.ddg_sampler_set_illegal_budget.restype = ctypes.c_int
_lib.ddg_sampler_set_illegal_budget.errcheck = _check_int
_lib.ddg_sampler_illegal_budget_stats.argtypes = [
    ctypes.c_void_p] + [ctypes.POINTER(ctypes.c_long)] * 3
_lib.ddg_sampler_illegal_budget_stats.restype = ctypes.c_int
_lib.ddg_sampler_illegal_budget_stats.errcheck = _check_int
...
_lib.ddg_sampler_slide_graph_scan.argtypes = [
